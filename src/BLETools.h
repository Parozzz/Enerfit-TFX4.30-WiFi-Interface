...
public:
    ...
    void init(NimBLEServer *bleServer, bool* connected);
...
public:
    ...
    BleSerial *initSerial()
    {
        ...
        _serial.init(_bleServer, &connected);
        return &_serial;
    }
    ...
    {   
        ...
        if (_serverCallbacks.authDone)
        {
            _serverCallbacks.authDone = false;
...
private:
    ...
    //BleClientCallbacks _securityCallbacks;
};
